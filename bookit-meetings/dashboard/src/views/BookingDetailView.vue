...
const shouldRender = computed( () => {
	return meetingsEnabled.value && supportedPlatform.value && Number.isInteger( activeBookingId.value ) && activeBookingId.value > 0
} )
...
function getDialogPresent() {
	return Boolean(
		document.querySelector( 'div[role="dialog"][aria-labelledby="booking-view-modal-title"]' )
	)
}
